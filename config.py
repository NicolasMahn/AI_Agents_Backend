...
llm_names = {
    ...
    "🧠💰 o3 mini": "o3-mini",
    "🥇📁 GPT 4.1 mini (Most Intelligent non-Reasoning)": "gpt-4.1-mini",
...
max_tokens = {
    ...
    "lfm-40b": 66000,
    "qwen25-coder-32b-instruct": 131000,
}
...
MODEL_OWNER = {
    "openai": ["o4-mini-high", "o4-mini", "o3-mini-high", "o3-mini", "gpt-4.1-mini", "gpt-4.1-nano", "gpt-4o-mini",
